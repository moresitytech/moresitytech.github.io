...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "web development, SaaS, mobile apps, AI, cloud, design, SEO, digital marketing" },
      { property: "og:title", content: "Services — Moresity Tech" },
      {
        property: "og:description",
        content: "Web, SaaS, mobile, AI, cloud, design, SEO, marketing.",
      },
      { property: "og:url", content: "https://tech.moresityholdings.com.np/services" },
    ],
    links: [{ rel: "canonical", href: "https://tech.moresityholdings.com.np/services" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          offers: [
            ...
            },
            {
              "@type": "Offer",
              name: "SaaS Platforms",
              description: "Multi-tenant systems, billing, dashboards and infrastructure that scale",
            },
            {
              "@type": "Offer",
              name: "Mobile Apps",
