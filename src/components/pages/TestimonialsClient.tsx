...
const QUOTES = [
  {
    quote:
      "Moresity rebuilt our platform in 9 weeks. Our activation tripled the quarter after launch.",
    author: "Sarah Kim",
    role: "CPO, Lumen",
  },
  {
    quote: "Easily the most thoughtful engineering team we've ever partnered with.",
    author: "David Alvarez",
    role: "CTO, Northwind",
  },
  {
    quote: "They ship like a founding team. The bar for quality is unreal.",
    author: "Priya Raman",
    role: "Head of Product, Helios",
  },
  {
    quote: "Senior, calm, and shockingly fast. A genuine extension of our team.",
    author: "Marcus Chen",
    role: "VP Eng, Atlas",
  },
  {
    quote: "Best engineering partner we've ever worked with — across two companies.",
    author: "Elena Volkov",
    role: "Founder, Orbit",
  },
  {
    quote: "The polish and care show up in every PR. Our users feel it.",
    author: "Jacob Tan",
    role: "Director, Vector",
  },
];
...
const VIDEOS = [
  ...
  {
    title: "Helios on the rebuild that worked",
    author: "Priya Raman · Head of Product",
    time: "4:28",
  },
];
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 md:px-6 md:py-28">
          <SectionHeader
            ...
            title={
              <>
                Quiet teams. <span className="text-gradient">Loud results.</span>
              </>
            }
            ...
            <StaggerItem key={v.title}>
              <div className="group relative overflow-hidden rounded-3xl border border-border bg-surface-elevated">
                <div className="relative aspect-video overflow-hidden bg-gradient-mesh">
                  ...
                  <span className="absolute bottom-3 right-3 rounded-full bg-surface-elevated/90 px-2.5 py-0.5 text-xs font-medium backdrop-blur">
                    {v.time}
                  </span>
                </div>
                <div className="p-5">
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 md:px-6">
        ...
        <Stagger className="mt-12 columns-1 gap-6 sm:columns-2 lg:columns-3">
          {QUOTES.map((t, i) => (
            <StaggerItem
              key={i}
              className="mb-6 break-inside-avoid rounded-3xl border border-border bg-surface-elevated p-7 shadow-soft"
            >
              ...
              <p className="mt-4 text-pretty text-base font-medium leading-relaxed text-foreground/90">
                &quot;{t.quote}&quot;
              </p>
        ...
        <Reveal>
          <div className="rounded-[2rem] border border-border bg-surface-elevated p-10 text-center md:p-14">
            ...
            <p className="mx-auto mt-3 max-w-lg text-sm text-muted-foreground">
              We earn long-term partnerships by delivering work our clients are excited to show
              their boards.
            </p>
          </div>
        </Reveal>
