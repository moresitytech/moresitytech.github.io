          ...
          <SectionHeader
            ...
            title={
              <>
                ...
                <span className="text-gradient">values craft over chaos.</span>
              </>
            }
          ...
          <div className="mt-12 grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
            <div className="rounded-[2rem] border border-border bg-surface-elevated p-8 shadow-soft">
              ...
              <p className="mt-5 text-sm leading-7 text-muted-foreground md:text-base">
                That means fewer openings, stronger teams, and the freedom to deliver at a high bar.
                If your work is thoughtful, user-centered, and built to last, let’s talk.
              </p>
              <Link
                href="/contact"
            ...
            <div className="grid gap-5">
              ...
              <div className="rounded-[2rem] border border-border bg-background/80 p-7 shadow-soft">
                ...
                <p className="mt-4 text-sm leading-7 text-muted-foreground">
                  Fast decisions, honest feedback, and a hiring process built to uncover strong,
                  practical experience — not perfect resumes.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 md:px-6">
        ...
        {ROLES.length > 0 ? (
          ...
          <div className="mt-10 overflow-hidden rounded-[2rem] border border-border bg-surface-elevated p-12 shadow-soft">
            <div
              className="pointer-events-none absolute inset-x-0 top-0 h-44 bg-gradient-primary opacity-10 blur-3xl"
              aria-hidden
            />
            <div className="relative text-center">
              ...
              <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-muted-foreground">
                We only open roles when the timing is right and the team truly needs another senior
                creator. If you want to stay connected, send us a note and we’ll reach out when the
                next role fits.
              </p>
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-4">
          {STEPS.map((s, i) => (
            <Reveal
              key={s.n}
              delay={i * 0.06}
              className="rounded-[2rem] border border-border bg-surface-elevated p-7 shadow-soft"
            >
